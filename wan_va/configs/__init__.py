...
from .va_robotwin_train_obj_pred_cfg import va_robotwin_train_obj_pred_cfg
from .va_robotwin_train_mask_weighted_cfg import (
    va_robotwin_train_mask_weighted_cfg,
)
...
from .va_robocasa_no_base_train_cfg import va_robocasa_no_base_train_cfg
...
VA_CONFIGS = {
    ...
    'robotwin_train_obj_pred': va_robotwin_train_obj_pred_cfg,
    'robotwin_train_mask_weighted': va_robotwin_train_mask_weighted_cfg,
    'demo': va_demo_cfg,
    ...
    'robocasa_no_base': va_robocasa_no_base_cfg,
    'robocasa_no_base_train': va_robocasa_no_base_train_cfg,
}
